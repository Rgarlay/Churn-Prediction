...
class ModelTrainer:
    ...
    def training_model(self, x_train,x_test,y_train,y_test):
        try:
            ...
            y_test_pred = best_model.predict(y_train)

            classification_train_metrics = get_classification_score(y_test=x_test, y_pred=y_train_pred)
            ...
            save_pickle_file(file_path=self.model_trainer_config.trained_model_file_path, file_to_save=churn_model)

            save_pickle_file(file_path=r'final_obj/model.pkl',file_to_save=churn_model)
